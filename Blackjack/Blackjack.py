...
def hit(deck, hand):                    # taking hits
    hand.add_card(deck.deal())
    hand.adjust_for_ace()


def hit_or_stand(deck, hand):           # player to take hits or stand
    global playing
...
def show_some(player, dealer):          # functions to display cards
    print("\nDealer's Hand")
    print(" <card hidden>")
